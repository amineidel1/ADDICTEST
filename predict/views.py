...
def resultat(request):
    ...
    Ethnicity = float(request.POST['ethnicitySelect'])
    Nscore = float(request.POST['nscore'])
    Escore = float(request.POST['escore'])
    Oscore = float(request.POST['oscore'])
    Cscore = float(request.POST['cscore'])
    Impulsive = float(request.POST['Impulsive'])
    Ss = float(request.POST['SS'])
    Ascore = float(request.POST["ascore"])
